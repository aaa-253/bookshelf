...
const SVG_ICON = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="camera-icon-svg"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"></path><circle cx="12" cy="13" r="4"></circle></svg><p class="upload-text">Cover Image</p>`;
...
window.addBook = function() {
   ...
   if (!titleInput || !titleInput.value.trim()) { alert("タイトルを入力してください"); return; }
   ...
   saveAndRender();
   titleInput.value = ""; authorInput.value = ""; memoInput.value = "";
...
function saveAndRender() { localStorage.setItem("color-log-v4", JSON.stringify(books)); render(); }
window.deleteBook = function(index) { if(confirm("削除しますか？")) { books.splice(index, 1); saveAndRender(); } }
